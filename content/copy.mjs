...
export const copy = {
  ...
  ko: {
    ...
    ir: {
      finance: {
        ...
        intro: 'DB월드의 최근 3개년 주요 재무지표입니다.',
        empty: '재무정보를 준비하고 있습니다. 확정 재무자료 반영 후 게시될 예정입니다.',
        bsTitle: '재무상태', isTitle: '경영성과',
        bsTableTitle: '재무상태표', isTableTitle: '손익계산서',
        catLabel: '구분',
        swipe: '\u2190 \uc88c\uc6b0\ub85c \ubc00\uc5b4\uc11c \ud655\uc778\ud558\uc138\uc694',
      },
      disclosure: {
  ...
  en: {
    ...
    ir: {
      finance: {
        title: 'Financial Highlights', docTitle: 'Financial Highlights | DB World',
        intro: 'Key financial indicators of DB World for the last three fiscal years.',
        empty: 'Financial information is being prepared and will be posted once finalized.',
        bsTitle: 'Financial Position', isTitle: 'Operating Results',
        bsTableTitle: 'Statement of Financial Position', isTableTitle: 'Income Statement',
        catLabel: 'Category',
        swipe: '\u2190 Swipe to see all years',
      },
      disclosure: {
