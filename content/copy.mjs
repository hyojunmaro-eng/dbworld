    ...
    home: {
      ...
      hero: [
        ...
        },
        {
          ...
          title: '공간에 새로운\n경험을 더하다',
          sub: 'DB금융센터를 비롯한 프라임 오피스의 자산가치를 높이는 전문 PM 서비스',
          img: 'dbfc-zoom', link: ['business/pm/', 'PM 사업 보기'],
        },
      ],
      areasTitle: '사업영역',
  ...
  en: {
    ...
    home: {
      ...
      hero: [
        ...
        {
          eyebrow: 'PROPERTY MANAGEMENT',
          title: 'Adding New Experiences\nto Every Space',
          sub: 'Professional property management that elevates prime assets, including the DB Financial Center in Seoul.',
          img: 'dbfc-zoom', link: ['business/pm/', 'Property management'],
        },
      ],
